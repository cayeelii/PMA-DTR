                  ...
                  <div className="font-bold text-lg sm:text-xl px-2 py-2 text-[#223488] flex items-center gap-2">
                      ...
                      >
                          <path
                              ...
                              d="M3 7a2 2 0 012-2h3.28a2 2 0 001.42-.59l1.3-1.3a2 2 0 012.83 0l1.3 1.3A2 2 0 0015.72 5H19a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"
                          />
                      </svg>
                      Current DTRs
                  </div>
                                  ...
                                  {filteredRows.length === 0 ? (
                                      ...
                                      filteredRows.map((row, idx) => (
                                          ...
                                          >
                                              ...
                                              <td className="py-2">
                                                  <button className="text-[#223488] hover:underline">
                                                      view details
                                                  </button>
                                              </td>
                                          </tr>

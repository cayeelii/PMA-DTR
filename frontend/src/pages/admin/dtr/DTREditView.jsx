...
function enforcedMaintenanceCellValue(entry, field, maintenanceMap, { soft = false } = {}) {
...
function mergeDtrWithFullCalendarRange(formattedRows, maintenanceMap = {}) {
    ...
    const keysForRange =
        dtrKeys.length > 0 ? dtrKeys : maintenanceKeys;
...
const DTREditView = ({ employee, batchId, onBack, onGenerateReport }) => {
    ...
    }, [employee, API_BASE_URL, maintenanceLoaded, maintenanceMap, resolvedBatchId]);
                            ...
                            {dtrEntries.map((entry, idx) => (
                                <tr
                                    ...
                                    className={`transition-colors hover:bg-gray-50 ${
                                        entry.maintenanceType === "Holiday"
                                            ? "bg-blue-100/80"
                                            : ""
                                    } ${
                                        isHalfDayMaintenanceType(

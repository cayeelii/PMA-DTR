...
const DepartmentView = ({ fileName, onReset }) => {
  return (
    <div className="bg-white rounded-xl shadow-sm p-8 max-w-5xl mx-auto">
      <div className="flex justify-between items-center mb-8">
        ...
        <div className="flex items-center gap-4">
          <button onClick={onReset} className="text-blue-600 hover:underline text-sm font-medium">Select other file</button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        {departments.map((dept, index) => (
          ...
          >
            <h3 className="text-xl font-bold text-gray-800 mb-1 group-hover:text-orange-500">{dept.name}</h3>

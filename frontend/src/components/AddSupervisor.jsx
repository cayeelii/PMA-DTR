...
import { X, User, KeyRound, IdCard, ChevronDown } from "lucide-react";
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                  placeholder="Enter Bio ID (max 6 digits)"
                  maxLength={6}
                  title="Bio ID must be 1 to 6 digits only."
                  required
                />
              </div>
            </div>
